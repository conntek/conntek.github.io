...
本类目覆盖三种感磁路线加一条光学路线：霍尔的 <a class="c-xref" href="/msite/products/encoder/kth78">KTH78</a>、<a class="c-xref" href="/msite/products/encoder/kth71">KTH71</a> 胜在低延时与在轴离轴通吃；AMR 的 <a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>、<a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a> 工作在饱和区（饱和磁场约 300 高斯），主要响应磁场方向而非强度，因而对磁铁加工误差与安装距离误差容忍度较高；TMR 的 <a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a> 与细分器 <a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a> 做到 180,000 rpm 与 30 bit；<a class="c-xref" href="/msite/products/encoder/kto95">KTO95</a> 是光学前端，输出正弦 / 余弦供后级插值。

## 怎么选

<p class="c-sec-lead">按下面几步缩小范围。</p>

<div class="c-features"><div class="c-feature"><span class="c-feature__no">01</span><div><h3>先定信号来源</h3><p>自带感磁选 <a class="c-xref" href="/msite/products/encoder/kth78">KTH78</a>、<a class="c-xref" href="/msite/products/encoder/kth71">KTH71</a>、<a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>、<a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a>、<a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a>；已有正余弦信号用 <a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a>。</p></div></div><div class="c-feature"><span class="c-feature__no">02</span><div><h3>再按精度定档</h3><p>校准后典型值：<a class="c-xref" href="/msite/products/encoder/kth78">KTH78</a> ±0.35°，<a class="c-xref" href="/msite/products/encoder/kth71">KTH71</a> ±0.1°，<a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a> ±0.015°，其余见下表。</p></div></div><div class="c-feature"><span class="c-feature__no">03</span><div><h3>核对转速上限</h3><p>转速上限：<a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>、<a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a> 为 60000 rpm，<a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a>、<a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a> 为 180,000 rpm，详见下表。</p></div></div><div class="c-feature"><span class="c-feature__no">04</span><div><h3>确认安装方式</h3><p>离轴精度已给出的是 <a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a>（±0.03°）、<a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a>（±0.05°）与 <a class="c-xref" href="/msite/products/encoder/kth78">KTH78</a>、<a class="c-xref" href="/msite/products/encoder/kth71">KTH71</a>；在轴优先选 <a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>。</p></div></div><div class="c-feature"><span class="c-feature__no">05</span><div><h3>对上后级接口</h3><p>替代增量光电编码器看 ABZ / UVW 位数；<a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a>、<a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a> 支持 36M SPI。</p></div></div></div>

## 系列对照

<div class="c-table c-table--links"><table><thead><tr><th>型号</th><th>技术与安装</th><th>分辨率</th><th>精度（INL）</th><th>最高转速</th></tr></thead><tbody><tr><td><a href="/msite/products/encoder/ktm52">KTM52 系列</a></td><td>AMR，在轴（产品页标注轴向安装）</td><td>21 bit</td><td>±0.015°（校准后典型值）</td><td>60000 rpm</td></tr><tr><td><a href="/msite/products/encoder/ktm53">KTM53 系列</a></td><td>AMR + 垂直霍尔，离轴</td><td>21 bit</td><td>±0.03°（离轴校准后典型值）</td><td>60000 rpm</td></tr><tr><td><a href="/msite/products/encoder/ktm58">KTM58 系列</a></td><td>细分器，接 AMR/TMR 或光编、光栅、磁栅</td><td>30 bit（单对极最高 18 bit）</td><td>±0.02°（非线性误差）</td><td>180,000 rpm</td></tr><tr><td><a href="/msite/products/encoder/ktm59">KTM59 系列</a></td><td>TMR，在轴 / 离轴</td><td>24 bit</td><td>在轴 ±0.02°，离轴 ±0.05°</td><td>180,000 rpm</td></tr><tr><td><a href="/msite/products/encoder/kth78">KTH78 系列</a></td><td>霍尔，在轴 / 离轴</td><td>16 bit</td><td>±0.35°（在轴）</td><td>120,000 rpm</td></tr><tr><td><a href="/msite/products/encoder/kth71">KTH71 系列</a></td><td>霍尔，在轴 / 离轴</td><td>16 bit</td><td>在轴 ±0.1°，离轴 ±0.2°（校准后）</td><td>120,000 rpm</td></tr><tr><td><a href="/msite/products/encoder/kto95">KTO95 系列</a></td><td>光学，3 码道游标，26 mm 码盘</td><td>24 bit（三通道 Nonius 插值）</td><td>—</td><td>—</td></tr></tbody></table></div>
...
<div class="c-grid c-grid--4"><a class="c-card" href="/msite/applications/industry4/servo-motor"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-servo-motor.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTM58xx</span><h3>伺服电机</h3></div></a><a class="c-card" href="/msite/applications/industry4/linear-motor"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-linear-motor.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTM58xx</span><h3>直线电机</h3></div></a><a class="c-card" href="/msite/applications/industry4/robot-joint"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-robot-joint.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTM59xx</span><h3>机器人关节</h3></div></a><a class="c-card" href="/msite/applications/consumer-electronics/drone-rotor"><div class="c-card__media c-media--case"><img src="/msite/img/case/consumer-electronics-drone-rotor.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTH78xx</span><h3>无人机旋翼</h3></div></a><a class="c-card" href="/msite/applications/industry4/bldc-motor"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-bldc-motor.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTH78xx</span><h3>无刷直流电机</h3></div></a><a class="c-card" href="/msite/applications/industry4/closed-loop-stepper"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-closed-loop-stepper.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTH78xx</span><h3>步进闭环</h3></div></a><a class="c-card" href="/msite/applications/industry4/coreless-motor"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-coreless-motor.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTH78xx</span><h3>空心杯电机</h3></div></a><a class="c-card" href="/msite/applications/industry4/elevator"><div class="c-card__media c-media--case"><img src="/msite/img/case/industry4-elevator.webp" alt="" loading="lazy"></div><div class="c-card__body"><span class="c-card__kicker">KTH78xx</span><h3>电梯</h3></div></a></div>

## 常见问题

::: details <a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a> 和 <a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a> 差在哪

<a class="c-xref" href="/msite/products/encoder/ktm59">KTM59</a> 自带 TMR 感磁，直接输出 24 bit 绝对角度；<a class="c-xref" href="/msite/products/encoder/ktm58">KTM58</a> 不感磁，需外接 AMR/TMR 或光编、光栅、磁栅的正余弦信号。

:::

::: details 自校准要做什么操作

<a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>、<a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a> 为用户侧一键自校准，补偿磁铁不理想与安装偏差引入的非线性误差；<a class="c-xref" href="/msite/products/encoder/kth71">KTH71</a> 内置 ANLC，写寄存器或引脚触发，结果存入片内 MTP。

:::

::: details 能替代增量光电编码器吗

<a class="c-xref" href="/msite/products/encoder/ktm52">KTM52</a>、<a class="c-xref" href="/msite/products/encoder/ktm53">KTM53</a> 的增量 ABZ 最高 65,536 脉冲/圈、UVW 1 ~ 64 对极；<a class="c-xref" href="/msite/products/encoder/kth78">KTH78</a> 为 ABZ 4 ~ 4096 步/圈。

:::

::: details <a class="c-xref" href="/msite/products/encoder/kto95">KTO95</a> 输出的是角度吗

不是。<a class="c-xref" href="/msite/products/encoder/kto95">KTO95</a> 输出 6 对模拟差分正弦 / 余弦信号，由后续设备插值，具体型号经三通道 Nonius 插值可达 24 位单圈分辨率。
