...
本类目覆盖三种感磁路线加一条光学路线：霍尔的 KTH78、KTH71 胜在低延时与在轴离轴通吃；AMR 的 KTM52、KTM53 工作在饱和区（饱和磁场约 300 高斯），主要响应磁场方向而非强度，因而对磁铁加工误差与安装距离误差容忍度较高；TMR 的 KTM59 与细分器 KTM58 做到 180,000 rpm 与 30 bit；KTO95 是光学前端，输出正弦 / 余弦供后级插值。

## 怎么选

<p class="c-sec-lead">按下面几步缩小范围。</p>

<div class="c-features"><div class="c-feature"><span class="c-feature__no">01</span><div><h3>先定信号来源</h3><p>自带感磁选 KTH78、KTH71、KTM52、KTM53、KTM59；已有正余弦信号用 KTM58。</p></div></div><div class="c-feature"><span class="c-feature__no">02</span><div><h3>再按精度定档</h3><p>校准后典型值：KTH78 ±0.35°，KTH71 ±0.1°，KTM52 ±0.015°，其余见下表。</p></div></div><div class="c-feature"><span class="c-feature__no">03</span><div><h3>核对转速上限</h3><p>转速上限：KTM52、KTM53 为 60000 rpm，KTM58、KTM59 为 180,000 rpm，详见下表。</p></div></div><div class="c-feature"><span class="c-feature__no">04</span><div><h3>确认安装方式</h3><p>离轴精度已给出的是 KTM53（±0.03°）、KTM59（±0.05°）与 KTH78、KTH71；在轴优先选 KTM52。</p></div></div><div class="c-feature"><span class="c-feature__no">05</span><div><h3>对上后级接口</h3><p>替代增量光电编码器看 ABZ / UVW 位数；KTM58、KTM59 支持 36M SPI。</p></div></div></div>
...
::: details KTM58 和 KTM59 差在哪

KTM59 自带 TMR 感磁，直接输出 24 bit 绝对角度；KTM58 不感磁，需外接 AMR/TMR 或光编、光栅、磁栅的正余弦信号。

:::

::: details 自校准要做什么操作

KTM52、KTM53 为用户侧一键自校准，补偿磁铁不理想与安装偏差引入的非线性误差；KTH71 内置 ANLC，写寄存器或引脚触发，结果存入片内 MTP。

:::

::: details 能替代增量光电编码器吗

KTM52、KTM53 的增量 ABZ 最高 65,536 脉冲/圈、UVW 1 ~ 64 对极；KTH78 为 ABZ 4 ~ 4096 步/圈。

:::

::: details KTO95 输出的是角度吗

不是。KTO95 输出 6 对模拟差分正弦 / 余弦信号，由后续设备插值，具体型号经三通道 Nonius 插值可达 24 位单圈分辨率。
