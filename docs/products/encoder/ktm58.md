...
KTM5800 是一款 30 bit 绝对角度、4096 对极编码细分器，可与磁电阻传感器（AMR/TMR）搭配，构成高速高精度的非接触磁性编码器模块。芯片以很高的采样速率读取传感器输出的差分模拟正弦、余弦信号，由高速数字电路完成角度计算并输出位置信息。
...
<div class="c-features"><div class="c-feature"><span class="c-feature__no">01</span><div><h3>高位细分</h3><p>单对极细分最高 18 bit，一圈最大 4096 对极输入</p></div></div><div class="c-feature"><span class="c-feature__no">02</span><div><h3>双路 ADC</h3><p>内置双 16 bit 2M SAR ADC，集成可编程增益运放</p></div></div><div class="c-feature"><span class="c-feature__no">03</span><div><h3>超低延时</h3><p>超高带宽输入，80M 内部主频</p></div></div><div class="c-feature"><span class="c-feature__no">04</span><div><h3>自动校准</h3><p>集成自动线性与非线性校准，单对极校准后 INL ≤ ±0.025°</p></div></div><div class="c-feature"><span class="c-feature__no">05</span><div><h3>高速 SPI</h3><p>最大支持 36M SPI 角度输出及寄存器读写</p></div></div><div class="c-feature"><span class="c-feature__no">06</span><div><h3>增量输出</h3><p>ABZ 1 ~ 65536 线、UVW 1 ~ 256 对极可编程</p></div></div><div class="c-feature"><span class="c-feature__no">07</span><div><h3>绝对值输出</h3><p>独立 PWM 绝对角度输出</p></div></div><div class="c-feature"><span class="c-feature__no">08</span><div><h3>多信号源适配</h3><p>适配光编、光栅、磁编、磁栅各类信号输入细分</p></div></div><div class="c-feature"><span class="c-feature__no">09</span><div><h3>宽温度范围</h3><p>工作温度 -40 ~ 125 ℃，5 mm × 5 mm 32 引脚封装</p></div></div></div>
