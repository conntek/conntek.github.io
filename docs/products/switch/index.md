...
全极对 N、S 极都动作；单 S 极、单 N 极只响应一种极性；锁存型要相反极性才复位，适合旋转计数。KTH16 与 KTM13 各型号覆盖这四类。
...
频率决定采样间隔与平均功耗：KTH16 覆盖 2.5 Hz ~ 40 kHz，KTM13 提供 50 Hz、1600 Hz、5000 Hz 三档。
